...
- 1)如果执行人对被执行标的物享有的抵押权设立在线，则案外人所提起执行异议很难得到支持，除非代被执行人偿还抵押债务；

- 2）司法实践中多数观点认为，只要满足《最高人民法院关于人民法院办理执行异议和复议案件若干问题的规定》28、29、30任一条规定的，即可以排除抵押权人对执行标的的执行。
...
- 1)正确识别确权，如房屋买卖合同中，买受人要求出卖人配合办理过户手续，就是一个非金钱债权的债权债务纠纷，不能在执行异议之诉中确权。只能在排除执行之后通过另案诉讼等方式实现所有权的转移；

- 2）确权不是案外人排除执行的前提，案外人排除执行只要求案外人享有足以排除执行的权利，包括所有权、物权期待权、租赁权等；
